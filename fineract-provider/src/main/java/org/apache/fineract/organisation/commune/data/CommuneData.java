 ...
 * under the License.
 */
package org.apache.fineract.organisation.commune.data;
...
public class CommuneData implements Serializable {
    ...
    public CommuneData(final Long id, final Long districtId, final String districtNameEng, final String code,
