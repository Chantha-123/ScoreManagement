...
public enum ChargeCalculationType {
    ...
    PERCENT_OF_OUTSTANDING_AMOUNT(6,"chargeCalculationType.percent.of.oustanding.amount");
    ...
    public static Object[] validValuesForLoan() {
        return new Integer[] { ChargeCalculationType.FLAT.getValue(), ChargeCalculationType.PERCENT_OF_AMOUNT.getValue(),
                ...
                ChargeCalculationType.PERCENT_OF_DISBURSEMENT_AMOUNT.getValue(),ChargeCalculationType.PERCENT_OF_OUTSTANDING_AMOUNT.getValue() };
    }
