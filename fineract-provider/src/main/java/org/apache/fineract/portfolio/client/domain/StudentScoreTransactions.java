...
public class StudentScoreTransactions extends AbstractPersistableCustom {
    ...
    public StudentScoreTransactions(Client client, Long stuedyerar_id, LocalDate transactiondate, Long class_id, Long score_type_id,
            Long subject_id, BigDecimal score_amount, boolean is_completed, Long monthly_id) {
        super();
        this.client = client;
        this.stuedyerar_id = stuedyerar_id;
        this.transactiondate = transactiondate;
